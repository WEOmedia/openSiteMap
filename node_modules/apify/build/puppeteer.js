...
exports.launchPuppeteer = async (options = {}) => {
    ...
    utils_1.checkParamOrThrow(options.useApifyProxy, 'options.useApifyProxy', 'Maybe Boolean');
    ...
    if (options.useApifyProxy && options.proxyUrl)
        throw new Error('Cannot combine "options.useApifyProxy" with "options.proxyUrl"!');
    ...
    if (optsCopy.useApifyProxy) {
        optsCopy.proxyUrl = actor_1.getApifyProxyUrl({
