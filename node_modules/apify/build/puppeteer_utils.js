...
exports.gotoExtended = async (page, request, gotoOptions = {}) => {
    ...
    if (method !== 'GET' || payload || !_.isEmpty(headers)) {
        ...
        const interceptRequestHandler = async (interceptedRequest) => {
            ...
            await puppeteer_request_interception_1.removeInterceptRequestHandler(page, interceptRequestHandler); // We wan't this to be called only for the initial request.
        };
