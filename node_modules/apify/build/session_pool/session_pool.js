...
class SessionPool extends events_1.EventEmitter {
     ...
     */
    constructor(options = {}) {
        const { maxPoolSize = 1000, persistStateKeyValueStoreId = null, persistStateKey = 'SESSION_POOL_STATE', createSessionFunction = null, sessionOptions = {}, } = options;
        super();
        // Validation
     ...
     */
    async persistState() {
        utils_log_1.default.debug('SessionPool: Persisting state', {
    ...
    _removeSession(session) {
        ...
        utils_log_1.default.debug(`SessionPool: Removed Session - ${removedSession.id}`);
    }
    /**
    ...
    async _createSession() {
        ...
        utils_log_1.default.debug(`SessionPool: Created new Session - ${newSession.id}`);
        return newSession;
    }
    /**
    ...
    async _maybeLoadSessionPool() {
        ...
        utils_log_1.default.debug('SessionPool: Recreating state from KeyValueStore', {
            persistStateKeyValueStoreId: this.persistStateKeyValueStoreId,
            persistStateKey: this.persistStateKey,
        });
        ...
        utils_log_1.default.debug(`SessionPool: ${this.usableSessionsCount} active sessions loaded from KeyValueStore`);
    }
}
