...
class Session {
     ...
     */
    constructor(options = {}) {
        const { id = `session_${utilities_1.cryptoRandomObjectId(10)}`, cookieJar = new tough_cookie_1.CookieJar(), maxAgeSecs = DEFAULT_SESSION_MAX_AGE_SECS, userData = {}, maxErrorScore = 3, errorScoreDecrement = 0.5, createdAt = new Date(), usageCount = 0, errorScore = 0, maxUsageCount = 50, sessionPool, } = options;
    ...
    setCookiesFromResponse(response) {
        try {
            ...
            utils_log_1.default.exception(e, 'Session: Could not get cookies from response');
        }
    }
    /**
    ...
    setPuppeteerCookies(cookies, url) {
        try {
            ...
            utils_log_1.default.exception(e, 'Session: Could not set cookies in puppeteer format.');
        }
    }
    /**
