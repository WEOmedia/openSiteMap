...
function computeUniqueKey({ url, method, payload, keepUrlFragment, useExtendedUniqueKey }) {
    ...
    if (!useExtendedUniqueKey) {
        if (normalizedMethod !== 'GET' && payload) {
            ...
            utils_log_1.default.deprecated(`We've encountered a ${normalizedMethod} Request with a payload. `
...
class Request {
     ...
     */
    doNotRetry(message) {
        utils_log_1.default.deprecated('request.doNotRetry is deprecated. Use request.noRetry = true; instead.');
        this.noRetry = true;
        if (message)
