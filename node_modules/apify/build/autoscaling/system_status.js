...
class SystemStatus {
     ...
     */
    constructor(options = {}) {
        const { currentHistorySecs, maxMemoryOverloadedRatio, maxEventLoopOverloadedRatio, maxCpuOverloadedRatio, maxClientOverloadedRatio, snapshotter, } = _.defaults({}, options, DEFAULT_OPTIONS);
        utils_1.checkParamOrThrow(currentHistorySecs, 'options.currentHistorySecs', 'Number');
        utils_1.checkParamOrThrow(maxMemoryOverloadedRatio, 'options.maxMemoryOverloadedRatio', 'Number');
        utils_1.checkParamOrThrow(maxEventLoopOverloadedRatio, 'options.maxEventLoopOverloadedRatio', 'Number');
        utils_1.checkParamOrThrow(maxCpuOverloadedRatio, 'options.maxCpuOverloadedRatio', 'Number');
        utils_1.checkParamOrThrow(maxClientOverloadedRatio, 'options.maxClientOverloadedRatio', 'Number');
        utils_1.checkParamOrThrow(snapshotter, 'options.snapshotter', 'Maybe Object');
    ...
    _isSampleOverloaded(sample, ratio) {
        ...
        const wAvg = utils_2.weightedAvg(values, weights);
        return {
