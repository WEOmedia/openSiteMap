 ...
 * @returns {boolean}
 */
const isNullOrUndefined = exports.isNullOrUndefined = function isNullOrUndefined(obj) {
 ...
 * @returns {*}
 */
const dateToString = exports.dateToString = function dateToString(date, middleT) {
 ...
 */
const truncate = exports.truncate = function (str, maxLength, suffix) {
 ...
 */
const getOrdinalSuffix = exports.getOrdinalSuffix = function (num) {
...
const parseUrl = exports.parseUrl = str => {
...
const normalizeUrl = exports.normalizeUrl = (url, keepFragment) => {
...
const markedSetNofollowLinks = exports.markedSetNofollowLinks = (href, title, text) => {
    let urlParsed;
    try {
...
const markedDecreaseHeadsLevel = exports.markedDecreaseHeadsLevel = (text, level) => {
    level += 1;
 ...
 */
const getPublicCrawlerNicePath = exports.getPublicCrawlerNicePath = (actId, customId, domain) => {
 ...
 * @return {string}
 */
const buildOrVersionNumberIntToStr = exports.buildOrVersionNumberIntToStr = int => {
 ...
 * @private
 */
const escapePropertyName = exports.escapePropertyName = name => {
    // From MongoDB docs:
 ...
 * @private
 */
const unescapePropertyName = exports.unescapePropertyName = function (name) {
    // pre-test to improve performance
