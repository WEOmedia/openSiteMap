...
exports.SPLIT_PATH_REGEX = exports.GITHUB_GIST_URL_REGEX = exports.URL_REGEX = exports.GITHUB_REGEX = exports.TWITTER_REGEX = exports.KEY_VALUE_STORE_KEY_REGEX = exports.PROXY_URL_REGEX = exports.APIFY_PROXY_VALUE_REGEX = exports.DNS_SAFE_NAME_REGEX = exports.GIT_REPO_REGEX = exports.EMAIL_REGEX = exports.EMAIL_REGEX_STR = void 0;
...
const GITHUB_REGEX = new RegExp(`^${GITHUB_REGEX_STR}$`, 'i'); // @TODO: Test this regex
// eslint-disable-next-line
// /^(?:(?:https?|ftp):\/\/)(?:\S+(?::\S*)?@)?(?:(?!10(?:\.\d{1,3}){3})(?!127(?:\.\d{1,3}){3})(?!169\.254(?:\.\d{1,3}){2})(?!192\.168(?:\.\d{1,3}){2})(?!172\.(?:1[6-9]|2\d|3[0-1])(?:\.\d{1,3}){2})(?:[1-9]\d?|1\d\d|2[01]\d|22[0-3])(?:\.(?:1?\d{1,2}|2[0-4]\d|25[0-5])){2}(?:\.(?:[1-9]\d?|1\d\d|2[0-4]\d|25[0-4]))|(?:(?:[a-z\u00a1-\uffff0-9]+-?)*[a-z\u00a1-\uffff0-9]+)(?:\.(?:[a-z\u00a1-\uffff0-9]+-?)*[a-z\u00a1-\uffff0-9]+)*(?:\.(?:[a-z\u00a1-\uffff]{2,})))(?::\d{2,5})?(?:\/[^\s]*)?$/i
// And if it works, use it instead

exports.GITHUB_REGEX = GITHUB_REGEX;
const URL_REGEX = /^(http:\/\/|https:\/\/)/i; // E.g. https://gist.github.com/jancurn/2dbe83fea77c439b1119fb3f118513e7
